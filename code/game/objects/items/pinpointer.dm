...
/obj/item/pinpointer/crew/proc/trackable(mob/living/carbon/human/H)
	...
	if(here && there && (there.z == here.z || (is_station_level(here) && is_station_level(there)))) // Device and target should be on the same level or different levels of the same station
